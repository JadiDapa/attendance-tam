...
export default async function SupervisorVerifikasiPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        subtitle="Karyawan/admin yang absen di luar radius kantor. Tinjau alasannya, lalu setujui atau tolak."
      />
